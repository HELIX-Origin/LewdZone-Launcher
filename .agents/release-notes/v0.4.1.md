...
- `fix(resolver): remove "Open in Browser" button now that "Open in App" is the primary capture path`
- `fix(download): auto-extract all supported archive formats and prevent scanner from re-processing active downloads`
- `fix(installer): adopt main-app custom titlebar style with traffic lights and theme glass`
- `chore(release): bump version to 0.4.1 and update changelog and release notes`
